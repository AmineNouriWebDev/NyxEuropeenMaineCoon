...
<section class="kitten-section purple-hero-bg" id="kittens">
  <div class="container">
    ...
    <div class="row justify-content-center mb-5">
      <div class="col-md-6 col-lg-4">
        <div class="p-4 bg-white rounded shadow-sm h-100 kitten-card">
          ...
          <h4>Excellence</h4>
          <p>We aim for the typical "wild look" of European lineages: strong muzzles, large ears with heavy lynx tips, and substantial bone structure.</p>
        </div>
      </div>
    </div>
    ...
    <div class="section-title">
      <h2>
        Our <span style="color: var(--accent-color)">Available Kittens & Cats</span>
      </h2>
      <p class="mt-3" style="max-width: 600px; margin: 0 auto">
        Each kitten is socialized, examined, and ready to bring joy to your home
      </p>
    </div>
                ...
                <div class="kitten-details">
                  ...
                  <div class="kitten-info-grid">
                    ...
                    <div class="info-item">
                      ...
                      <span><?php echo strtolower($cat['gender']) == 'male' ? 'Male' : (strtolower($cat['gender']) == 'female' ? 'Female' : 'To determine'); ?></span>
                    </div>
                  ...
                  <div class="d-flex justify-content-between mt-3" style="gap: 10px;">
                    <?php if (!empty($cat['father_id']) && !empty($cat['father_name'])): ?>
                      <a href="chat_details.php?id=<?php echo $cat['father_id']; ?>" class="btn-cat btn-sm flex-fill text-center" style="font-size: 0.8rem; padding: 8px 12px;">
                        <i class="fas fa-crown text-warning mr-1"></i> See Dad
                      </a>
                    <?php endif; ?>
                    <?php if (!empty($cat['mother_id']) && !empty($cat['mother_name'])): ?>
                      <a href="chat_details.php?id=<?php echo $cat['mother_id']; ?>" class="btn-cat btn-cat-secondary btn-sm flex-fill text-center" style="font-size: 0.8rem; padding: 8px 12px;">
                        <i class="fas fa-heart text-danger mr-1"></i> See Mom
                      </a>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="kitten-actions mt-3">
                    ...
                    <a href="javascript:void(0);" onclick="openInquiryModal('<?php echo $cat['id']; ?>', '<?php echo addslashes(htmlspecialchars($cat['name'])); ?>')" class="btn-cat btn-cat-secondary btn-sm">Inquire</a>
                  </div>
                </div>
              </div>
            </div>
...
<div id="inquiryModal" class="inquiry-modal">
  <div class="inquiry-modal-content">
    <div class="inquiry-modal-header">
      <h2 id="modalCatName">Inquire about ...</h2>
    ...
    <div class="inquiry-modal-body">
      <form id="inquiryForm" onsubmit="submitInquiry(event)">
        ...
        <div class="form-group">
          ...
          <input type="text" id="visitorName" name="visitor_name" required placeholder="Your full name">
        </div>
        
        <div class="form-group">
          <label for="visitorPhone">Phone</label>
          <input type="tel" id="visitorPhone" name="visitor_phone" placeholder="Your phone number">
        </div>
        
        <div class="form-group">
          <label for="visitorEmail">Email</label>
          <input type="email" id="visitorEmail" name="visitor_email" required placeholder="your.email@example.com">
        </div>
        
        <div class="form-group">
          <label for="visitorMessage">Message</label>
          <textarea id="visitorMessage" name="message" rows="4" required placeholder="Hello, I am interested in this kitten..."></textarea>
        </div>
...
function openInquiryModal(catId, catName) {
  ...
  document.getElementById('modalCatName').textContent = 'Inquire about ' + catName;
