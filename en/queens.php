...
<div class="litter-hero text-center py-5">
    <h1 class="font-weight-bold display-4" style="margin-top: 200px; font-family: 'Amatic SC', cursive;">Our Queens</h1>
    <p class="lead" style="color: rgba(255,255,255,0.9);">Our magnificent females, the foundation of our cattery. Gentleness and beauty combined.</p>
</div>
    ...
    <div class="section-title">
      <?php if ($selected_id && !empty($cats)): ?>
          <div class="alert alert-info d-inline-block">
              <i class="fas fa-crown"></i> Dam Profile
          </div>
          ...
          <div class="mt-3">
              <a href="queens.php" class="btn btn-outline-primary btn-sm rounded-pill">
                  <i class="fas fa-th-large"></i> See all Queens
              </a>
          </div>
      <?php else: ?>
    ...
    <div class="row" id="cats-grid">
      <?php if(empty($cats)): ?>
          <div class="col-12 text-center p-5">
              <h3><?php echo $selected_id ? 'This Queen is not found.' : 'No Queens presented at the moment.'; ?></h3>
              <?php if ($selected_id): ?>
                  <a href="queens.php" class="btn btn-primary mt-3">See all Queens</a>
              <?php endif; ?>
          </div>
      <?php else: ?>
              ...
              <div class="kitten-card">
                ...
                <div class="kitten-details">
                  ...
                  <div class="kitten-price-container mt-3 px-3 py-2" style="background: #f8f9fa; border-radius: 12px; border: 1px solid #eee;">
                    <div>
                      <small class="text-muted d-block mb-1"><i class="fas fa-home text-success"></i> Available for Retirement</small>
