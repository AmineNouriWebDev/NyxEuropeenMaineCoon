    ...
    <div class="container">
        <div class="hero-content text-center">
            ...
            <p class="hero-subtitle">
                Discover our future exceptional pairings and reserve your dream kitten
            </p>
        </div>
    </div>
</div>

<section class="litter-section purple-hero-bg">
    <div class="container">
        <?php if (empty($litters)): ?>
            <div class="empty-state">
                ...
                <h3>No upcoming litters announced for the moment</h3>
                <p>Come back soon to discover our future exceptional pairings!</p>
            </div>
        <?php else: ?>
                    ...
                    <div class="litter-card-body">
                                    ...
                                    <div class="cat-info-panel">
                                        ...
                                        <div class="cat-actions">
                                            ...
                                            <div class="parent-buttons">
                                                ...
                                                <a href="chat_details.php?id=<?php echo $litter['mother_father_id']; ?>" class="btn-parent" title="Dad of <?php echo htmlspecialchars($litter['mother_name']); ?>">
                                                    <i class="fas fa-male"></i> Dad
                                                </a>
                                                <?php endif; ?>
                                                <?php if (!empty($litter['mother_mother_id'])): ?>
                                                <a href="chat_details.php?id=<?php echo $litter['mother_mother_id']; ?>" class="btn-parent" title="Mom of <?php echo htmlspecialchars($litter['mother_name']); ?>">
                                                    <i class="fas fa-female"></i> Mom
                                                </a>
                                                <?php endif; ?>
                                            </div>
                                            <?php endif; ?>
                                    ...
                                    <div class="cat-info-panel">
                                        ...
                                        <div class="cat-actions">
                                            ...
                                            <div class="parent-buttons">
                                                ...
                                                <a href="chat_details.php?id=<?php echo $litter['father_father_id']; ?>" class="btn-parent" title="Dad of <?php echo htmlspecialchars($litter['father_name']); ?>">
                                                    <i class="fas fa-male"></i> Dad
                                                </a>
                                                <?php endif; ?>
                                                <?php if (!empty($litter['father_mother_id'])): ?>
                                                <a href="chat_details.php?id=<?php echo $litter['father_mother_id']; ?>" class="btn-parent" title="Mom of <?php echo htmlspecialchars($litter['father_name']); ?>">
                                                    <i class="fas fa-female"></i> Mom
                                                </a>
                                                <?php endif; ?>
                                            </div>
                        ...
                        <div class="litter-details">
                            ...
                            <div class="expected-colors-section">
                                <h5 class="colors-title">
                                    <i class="fas fa-palette"></i> Probable Colors
                                </h5>
                        ...
                        <div class="litter-cta">
                            <a href="adoption.php#formulaire-adoption" class="btn-waiting-list">
                                ...
                                <span class="btn-text text-white">Join the priority list</span>
    ...
    <div class="modal-container">
        <div class="modal-header">
            <h4 class="modal-title">
                <i class="fas fa-pencil-alt"></i> Waiting List
            </h4>
        ...
        <div class="modal-body">
            <p class="modal-subtitle">
                Registration for litter: <strong id="modalLitterName"></strong>
            </p>
            ...
            <form id="waitingForm">
                ...
                <div class="form-group">
                    <label>Your Preferences / Message</label>
                    <div class="input-wrapper">
                        <i class="fas fa-comment"></i>
                        <textarea name="message" rows="3" placeholder="Sex, color, character preference..."></textarea>
                    </div>
                </div>
